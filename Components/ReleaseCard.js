...
export default function ReleaseCard(props) {
  ...
  return (
    <div className="text-center rounded-2xl mx-auto overflow-hidden max-w-sm bg-lightmodeRed shadow-lg shadow-gray-300 font-poppins pb-5">
      <div className="m-4">
      ...
      <h4 className="my-3 bg-green-300 px-2 inline rounded-lg">{day + (day>10 && day<20 ? 'th' : {1:'st', 2:'nd', 3:'rd'}[day % 10] || 'th')}</h4>
    </div>
  )
}